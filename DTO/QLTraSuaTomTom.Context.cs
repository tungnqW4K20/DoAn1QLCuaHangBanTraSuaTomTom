...
namespace DTO
{
    ...
    public partial class QuanLyCuaHangBanTraSuaTomTomEntities3 : DbContext
    {
        public QuanLyCuaHangBanTraSuaTomTomEntities3()
            : base("name=QuanLyCuaHangBanTraSuaTomTomEntities3")
        {
        }
